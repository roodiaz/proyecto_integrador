...
public class MarketServiceTests
{
    ...
    private MarketService CreateService()
    {
        ...
        _marketStatusService.Setup(x => x.GetStatus()).Returns(new MarketStatusDto());
        return new(_providerResolver.Object, _logger.Object, _assetService.Object, _marketPriceCacheService.Object, _marketStatusService.Object);
    }
